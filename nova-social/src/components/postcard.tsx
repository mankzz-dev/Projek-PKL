...
export default function PostCard() {
  return (
    <div className="bg-[#0f0716] px-4 py-4 text-white border-b border-[#ffffff]/20">
      ...
      {/* Content + Image */}
      <div className="flex flex-col md:flex-row gap-4 mb-3 ml-12 md:ml-12">
        {/* Text */}
        <p className="text-sm leading-relaxed md:w-1/2 w-full">
      ...
      {/* Action Bar */}
      <div className="flex flex-wrap items-center gap-4 ml-12 text-[#f800f8] text-sm">
        {/* Like */}

            ...
            <div className="container mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    {careers.map((career, index) => (
                        <div key={index} className="bg-[#2A3B4E] p-6 rounded-3xl shadow-md text-left transition-all duration-300 hover:shadow-lg hover:-translate-y-2 hover:bg-[#32465E]">
                            ...
                            <div className="mt-4">
                                <a 
                                    href={career.url} 
                                    className="inline-block bg-blue-500 text-white px-4 py-2 rounded-2xl hover:bg-blue-600 transition-all duration-300"
                                >
                                    Lihat Detail
                                </a>
                            </div>
